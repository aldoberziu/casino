export const works = [
  "Ju fute punes si turku sumes. Ti gzosh {}💸.",
  "I hape vorrin ex-it. Qe ke baba {}💸.",
  "Na {}💸 kot se mdo rika mu.",
  "Tu punu si gjinekolog, klienti tdha karin ene {}💸.",
  "{}💸 meqe sot parazitove ndivan si lord.",
  "U kpute nbyth me aq mo. {}💸 boll i ke.",
  "Brravo, qe dora, kompllimente. {}💸 per ty.",
];
export const niceSluts = [
  "Oooooo cm knoqe. Ti gzosh kto {}💸.",
  "Koka nlum lodra nsum. I meritove {}💸.",
  "E thirre klientin President. Tka shperbly me {}💸.",
  "Ja le virgjerin kismetit, ja qive ropt muhabetit. {}💸",
  "Plak plak pidhi flak! {}💸 ndor."
];
